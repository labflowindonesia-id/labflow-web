...
const targetDirs = [
    ...
    path.join(projectRoot, 'public', 'resources')
];
...
async function optimizeImages() {
    ...
    for (const resourcesDir of targetDirs) {
        if (!fs.existsSync(resourcesDir)) {
            console.log(`⚠️ Directory not found, skipping: ${resourcesDir}`);
            continue;
        }

        console.log(`\n📂 Scanning directory: ${resourcesDir}`);
